...
<body class="bg-gray-50 font-inter">
    <div class="flex min-h-screen">
        <div class="hidden lg:flex w-1/2 bg-[#0A1628] items-center justify-center p-12 text-center">
            <div class="max-w-md">
                <div class="w-20 h-20 bg-transparent rounded-2xl mx-auto mb-4 flex items-center justify-center">
                    <img src="{{ asset('assets/login/gedung.webp') }}" alt="Icon Gedung" class="w-14 h-17 object-contain">
                </div>
