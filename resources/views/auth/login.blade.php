    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white lg:bg-transparent">
            ...
            <div class="w-full max-w-md bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
                ...
                <p class="text-gray-500 mb-8 text-center">Sign in to access your dashboard</p>

                {{-- Success flash (misal setelah register) --}}
                @if (session('success'))
                ...
                <p class="text-center text-gray-500 mt-8">
                    ...
                    <a href="{{ route('register') }}" class="text-[#0A1628] font-bold hover:underline">Register</a>
                </p>
